...
def generate_jsonl(out: str|Path,n:int,seed=1234,split="train",min_hops=1,max_hops=6):
    ...
    with p.open("w",encoding="utf-8") as f:
        for i in range(n):
            ...
            ex=make_example(rng,hops,rng.randint(0,4),rng.choice(transforms),(rng.randint(-20,20),rng.randint(-20,20)) if split!="train" else (0,0),renamed=(split!="train" and rng.random()<0.5))
